...
def get_version():
    ...
    version = None
    version_file = os.path.join(BASEDIR, 'ovos_jabir_solver', 'version.py')
...
PLUGIN_ENTRY_POINTS = [
    'ovos-solver-jabir-solver-plugin=ovos_jabir_solver:JabirLLMSolver'
]
...
setup(
    ...
    url='https://github.com/TigreGotico/ovos-solver-jabir-plugin',
    author='jarbasai',
    author_email='jarbasai@mailfence.com',
    license='MIT',
    packages=['ovos_jabir_solver'],
    zip_safe=True,
